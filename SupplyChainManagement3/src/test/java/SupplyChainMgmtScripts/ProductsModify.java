...
public class ProductsModify {
	public static void main(String[] args) throws InterruptedException, IOException {
		System.setProperty("webdriver.edge.driver", "./SeleniumJarFiles/msedgedriver.exe");		
					...
					String Product = excellib.ToGetDataFromExcel("ProductModify", 1, 0);
					String Price = excellib.ToGetDataFromExcel("ProductModify", 1, 1);
					String UnitType = excellib.ToGetDataFromExcel("ProductModify", 1, 2);
					String Category = excellib.ToGetDataFromExcel("ProductModify", 1, 3);			
					String ProDescription = excellib.ToGetDataFromExcel("ProductModify", 1, 5);
