...
public class ModifyRetailer {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			String Name=excellib.ToGetDataFromExcel("RetailerModify", 1, 0);
			String Password=excellib.ToGetDataFromExcel("RetailerModify", 1, 1);
			String Areacode=excellib.ToGetDataFromExcel("RetailerModify", 1, 2);
			String Phone=excellib.ToGetDataFromExcel("RetailerModify", 1, 3);
			String Email=excellib.ToGetDataFromExcel("RetailerModify", 1, 4);
			String Address=excellib.ToGetDataFromExcel("RetailerModify", 1, 5);
