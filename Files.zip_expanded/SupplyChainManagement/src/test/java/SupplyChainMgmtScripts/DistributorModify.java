...
public class DistributorModify {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		// Creating the Objects for the GenericUtilities
					...
					String Name=excellib.ToGetDataFromExcel("DistributorModify", 1, 0);
					String Email=excellib.ToGetDataFromExcel("DistributorModify", 1, 1);
					String Phone=excellib.ToGetDataFromExcel("DistributorModify", 1, 2);
					String Address=excellib.ToGetDataFromExcel("DistributorModify", 1, 3);
