...
public class ManufacturerModify {
		...
		public static void main(String[] args) throws EncryptedDocumentException, FileNotFoundException, IOException, InterruptedException {
			...
			// Creating the Objects for the GenericUtilities
						...
						String Name = excellib.ToGetDataFromExcel("ManufacturerModify", 1, 0);
						String Email = excellib.ToGetDataFromExcel("ManufacturerModify", 1, 1);
						String Phone = excellib.ToGetDataFromExcel("ManufacturerModify", 1, 2);
						String Username = excellib.ToGetDataFromExcel("ManufacturerModify", 1, 3);			
						String Password = excellib.ToGetDataFromExcel("ManufacturerModify", 1, 4);
